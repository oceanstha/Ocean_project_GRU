...
# Prepare the training data for GRU training
X_train = []
y_train = []
...
df_train.to_csv('/home/ocean/Documents/nepse_train_file_predictedGRU.csv', index=False)
df_test.to_csv('/home/ocean/Documents/nepse_test_file_predictedGRU.csv', index=False)
